...
@NamedQueries({
    ...
    @NamedQuery(name = "Commenti.findByIdComm", query = "SELECT c FROM Commenti c WHERE c.idComm = :idComm"),
    @NamedQuery(name = "Commenti.findByCommento", query = "SELECT c FROM Commenti c WHERE c.commento = :commento"),
