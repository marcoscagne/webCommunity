    ...
    <body id="page-top" class="index">
        ...
        <section id="portfolio">
            <div class="container">
                ...
                <div class="row">
                    <c:forEach items="${pastEvents}" var="pe">
                        <div class="col-sm-4 portfolio-item">
                            <a href="#" onclick="apriModal(${pe.idEvento})" class="portfolio-link" data-toggle="modal">
                                <div class="caption">
                                    <div class="caption-content">
                                        <i class="fa fa-search-plus fa-3x"></i>
                                        <br/><br/>${pe.titolo}
                                ...
                                <img src="${pe.foto}" style="width: 393px; height: 284px;" class="img-responsive" alt="">
                            </a>
                        </div>
                    </c:forEach>
                </div>
        ...
        <c:forEach items="${pastEvents}" var="pe">
            <!-- Portfolio Modals -->
            <div class="portfolio-modal modal fade" id="modal${pe.idEvento}" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-content">
                    <div class="close-modal" data-dismiss="modal">
                        <div class="lr">
                            <div class="rl">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-lg-offset-2">
                                <div class="modal-body">
                                    <h2>${pe.titolo}</h2>
                                    <hr class="star-primary">
                                    <img src="${pe.foto}" class="img-responsive img-centered" alt="">
                                    <p>${pe.descrizione}</p>
                                    <ul class="list-inline item-details">
                                        <li>Inserito da:
                                            <strong><a>${pe.utente.nickname}</a>
                                            </strong>
                                        </li>
                                        <li>Data Evento:
                                            <strong><a>${pe.data}</a>
